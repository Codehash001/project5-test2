...
useEffect(() => {
  Aos.init({ duration : 1000})
    ...
    <div id="home"className='overflow-hidden flex flex-col'>
        <div data-aos="fade-up" className="w-full h-screen flex flex-col items-center justify-center relative">
        <img
          src="/banner2.jpg"
        ...
        <div className='mt-6 top-[100px] left-10 absolute flex flex-col items-start'>
          ...
          <div data-aos="fade-down"className='md:text-[64px] text-[40px] text-white leading-relaxed font-semibold font-Kanit  tracking-widest uppercase' >
...
for each character. It is fun beyond the limit.
            ...
            <h1 data-aos="slide-right" className='text-3xl font-Kanit text-white tracking-wide mt-6'>Features</h1>
            <h1 data-aos="slide-right" className='text-[16px] font-Kanit text-gray-400 text-justify mt-4'>
