...
for each character. It is fun beyond the limit.
            ...
            <h1 data-aos="fade-right" className='text-3xl font-Kanit text-white tracking-wide mt-6'>Features</h1>
            <h1 data-aos="fade-right" className='text-[16px] font-Kanit text-gray-400 text-justify mt-4'>
