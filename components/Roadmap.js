  ...
  <div className='flex flex-col w-full h-full'>
    <div className='flex flex-col '>
      ...
      <div className=' h-auto w-0.5 border border-white mt-0 ml-4'></div>
         <ol className="m-6 ml-10 font-Kanit tracking-wide list-disc text-gray-6400 text-2xl">
    ...
    <div className='flex flex-col '>
      ...
      <div className='flex flex-row '>
      <div className=' h-auto w-0.5 border border-white mt-0 ml-4'></div>
         <ol className="m-6 ml-10 font-Kanit tracking-wide list-disc text-gray-600 text-2xl">
        <li>Launch Nft</li>
        <li>Launch token</li>
