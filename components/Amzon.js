...
useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-tr from-[#141414] to-[#330042] justify-center items-center pb-10 flex flex-col overflow-hidden">

<div className='fixed z-[100] w-screen mx-10 md:mx-10 lg:mx-10 bg-black/30 backdrop-blur-sm overflow-hidden border-b-white rounded-md my-4'>
