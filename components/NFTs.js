...
function Nfts () {
    ...
    <div className='flex flex-col my-10 mx-16 justify-between items-center'>
       <div className='mt-10'>
        ...
        <p data-aos="flip-right" className='text-center font-Kanit text-[20px] bg-gradient-to-r from-cyan-50 via-indigo-200 to-fuchsia-200 bg-clip-text text-transparent mt-4 mb-5'>
